...
/// شريط chat presets — مع cooldown مرئي.
class LudoQuickChatBar extends ConsumerStatefulWidget {
  const LudoQuickChatBar({super.key, required this.onSend});
  final void Function(String presetKey) onSend;

  @override
  ConsumerState<LudoQuickChatBar> createState() => _LudoQuickChatBarState();
}

class _LudoQuickChatBarState extends ConsumerState<LudoQuickChatBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final asyncPresets = ref.watch(ludoChatPresetsProvider);
    return Container(
