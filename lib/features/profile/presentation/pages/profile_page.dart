...
class _BadgesRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Centered row — RTL ListView felt right-stacked which made the
    // identity card look unbalanced. Wrap.center keeps everything optical
    // centered regardless of locale + still allows wrapping on narrow
    // phones if a future 4th badge gets added.
    return Padding(
